    ...
    <div class="card-body">
      <form action="" method="post" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="name" name="name" placeholder="Enter Supplier's Name.." value="<?php echo set_value('name'); ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="credit_card_type" name="credit_card_type" placeholder="Bank Name.." value="<?php echo set_value('credit_card_type'); ?>">
          <small class="form-text text-danger"><?= form_error('credit_card_type'); ?></small>
        </div>

        <div class="form-group">
          <label for="">Bank Account Number</label>
          <input type="text" class="form-control" id="credit_card_number" name="credit_card_number" placeholder="Bank Account Number.." value="<?php echo set_value('credit_card_number'); ?>">
