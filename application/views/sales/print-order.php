      ...
      <div class="card-body">
        <div class="row mb-4">
          ...
          <div class="col-sm-6">
            <h6 class="mb-3">To:</h6>
            <div>
              <strong><?php echo $order_data['customer_name'] ?></strong>
            </div>
            <div><?php echo $order_data['customer_address'] ?></div>
            <div><?php echo $order_data['customer_phone'] ?></div>
          </div>
            ...
            <table class="table table-clear">
              <tbody>
                <tr>
                  ...
                  <td class="right"><?php echo $order_data['gross_amount'] ?></td>
                </tr>

                <?php if ($order_data['service_charge'] > 0) : ?>
                  <tr>
                    <td class="left">
                      <strong>Service Charge (<?php echo $order_data['service_charge_rate'] ?>%)</strong>
                    </td>
                    <td class="right"><?php echo $order_data['service_charge'] ?></td>
                  </tr>
                <?php endif; ?>
                ...
                <?php if ($order_data['vat_charge'] > 0) : ?>
                  <tr>
                    <td class="left">
                      <strong>Vat Charge (<?php echo $order_data['vat_charge_rate'] ?>%)</strong>
                    </td>
                    <td class="right"><?php echo $order_data['vat_charge'] ?></td>
                  </tr>
                <?php endif; ?>
