...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 04:06 PM
...
('PROD-0754100919', 'Sikat Gigi', 'BRD-1710291019', 'CAT-1709021019', 'SPL-1948070919', 'product_1573882836.png', 'Sikat gigi untuk dewasa', 11500, '110', 1, '2019-10-27 15:29:48', '2019-11-16 12:40:46'),
('PROD-0952071019', 'Minyak Wangi', 'BRD-1823050919', 'CAT-1811060919', 'SPL-1948070919', 'product_1571471527.png', 'Ini product berbau wangi', 12500, '90', 1, '2019-10-27 15:29:51', '0000-00-00 00:00:00'),
...
CREATE TABLE `purchase_debts` (
  ...
  `debt_paid_history` date NOT NULL,
  `amount_paid` int(11) NOT NULL,
  `remaining_paid` int(11) NOT NULL,
  `user_insert` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `purchase_debts`
--

INSERT INTO `purchase_debts` (`purchase_debt_id`, `order_id`, `debt_paid_history`, `amount_paid`, `remaining_paid`, `user_insert`) VALUES
('DEBT-1743331219', 'BUY-1743331219', '2019-12-07', 10000, 105000, 'admin@admin.com'),
('DEBT-1743331219', 'BUY-1743331219', '2019-12-09', 5000, 100000, 'admin@admin.com');
...
('BUY-0333341119', 'SPL-1712201019', '2019-11-08', 512500, 0, 0, 5, 486875, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 22:40:42'),
('BUY-0410531119', 'SPL-1711351019', '2019-10-03', 477500, 8000, 10, 0, 534050, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 17:54:43'),
('BUY-0509231119', 'SPL-1712201019', '2019-11-25', 11500, 0, 0, 0, 11500, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-0549341119', 'SPL-1712201019', '2019-11-16', 500000, 0, 0, 0, 500000, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-0607161119', 'SPL-1712201019', '2019-11-08', 312500, 0, 0, 0, 312500, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-1139311119', 'SPL-1712201019', '2019-11-11', 14000, 0, 0, 0, 14000, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 22:35:43'),
('BUY-1201091119', 'SPL-1711351019', '2019-11-18', 470500, 0, 0, 0, 470500, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-25 10:53:16'),
('BUY-1206021119', 'SPL-1711351019', '2019-10-01', 4815500, 20000, 10, 15, 4521193, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 22:41:20'),
('BUY-1737411219', 'SPL-1712201019', '2019-12-07', 125000, 0, 0, 0, 125000, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-1743331219', 'SPL-1712201019', '2019-12-07', 115000, 0, 0, 0, 115000, 'Belum Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-1825091119', 'SPL-1712201019', '2019-11-11', 14000, 0, 0, 0, 14000, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 22:35:52'),
('BUY-1835511119', 'SPL-1712201019', '2019-11-18', 14000, 0, 0, 0, 14000, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 17:41:47'),
('BUY-1838171119', 'SPL-1712201019', '2019-11-01', 500000, 0, 0, 0, 500000, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-1841061119', 'SPL-1712201019', '2019-11-08', 485000, 0, 0, 5, 460750, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('BUY-1844071119', 'SPL-1948070919', '2019-11-08', 485000, 0, 0, 5, 460750, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00');
...
('BUY-1737411219', 'PROD-0952071019', 12500, 10, 125000),
('BUY-1743331219', 'PROD-0754100919', 11500, 10, 115000);
...
CREATE TABLE `sales_account_receivables` (
  ...
  `user_insert` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `sales_account_receivables`
--

INSERT INTO `sales_account_receivables` (`sales_ar_id`, `order_id`, `ar_paid_history`, `amount_paid`, `remaining_paid`, `user_insert`) VALUES
('SAR-0815521219', 'SELL-0815521219', '2019-12-09 00:00:00', 60000, 200000, 'admin@admin.com'),
('SAR-0815521219', 'SELL-0815521219', '2019-12-09 00:00:00', 50000, 150000, 'admin@admin.com');
...
CREATE TABLE `sales_orders` (
  ...
  `gross_amount` int(16) NOT NULL,
  `service_charge_rate` int(16) NOT NULL,
  `service_charge` int(16) NOT NULL,
  `vat_charge_rate` int(16) NOT NULL,
  `vat_charge` int(16) NOT NULL,
  `net_amount` int(16) NOT NULL,
...
('SELL-0604361019', 'Bambang Waluyo', '076123978345', 'Jalan Dagu Raya no.07', '2019-11-25', 171500, 20, 34300, 10, 17150, 222950, 0, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 21:22:34'),
('SELL-0618551119', 'Rudy Cahyono', '082543715913', 'Jalan kesana kemari hey no 12', '2019-11-17', 90000, 20, 18000, 10, 9000, 117000, 0, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-27 12:29:36'),
('SELL-0815521219', 'Yanto Pede', '089132456789', 'Jalan Barengan Aja', '2019-12-09', 250000, 20, 50000, 10, 25000, 260000, 20, 'Belum Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('SELL-0927511219', 'Haryanto', '081789432123', 'Jalan Bagus Sekali, Bandung', '2019-12-05', 250000, 20, 50000, 10, 25000, 325000, 0, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00'),
('SELL-1223301019', 'Mawar Merah', '81234567', 'Jalan Sesama B no.21 ', '2019-11-25', 46600, 20, 9320, 10, 4660, 60560, 20, 'Lunas', 'admin@admin.com', 'admin@admin.com', '2019-11-18 21:08:27'),
('SELL-1320221019', 'Sutrisno', '296785234', 'Jalan Cielunyi no.21a', '2019-11-25', 136000, 20, 27200, 10, 13600, 176800, 0, 'Lunas', 'admin@admin.com', '', '2019-10-25 20:33:56'),
('SELL-1812051019', 'Joko Wie', '21678234', 'Jalan Baru no.12', '2019-11-25', 197500, 20, 39500, 10, 19750, 256750, 0, 'Lunas', 'admin@admin.com', 'budiman@gmail.com', '2019-11-25 09:13:04'),
('SELL-1902221019', 'qweqweqwe', '123123123', 'asdasd123123asdasd', '2019-11-25', 14000, 20, 2800, 10, 1400, 18200, 0, 'Lunas', 'admin@admin.com', '', '0000-00-00 00:00:00');
...
(28, 'SELL-0927511219', 'PROD-0952071019', 20, 12500, 250000),
(29, 'SELL-0815521219', 'PROD-0952071019', 20, 12500, 250000);
...
(1, 'Admin Warehouse', 'admin@admin.com', 'default1.png', '$2y$10$ojVg/Mvr9wpLnHNd.9AxXOlpSEWuivT9dQDbnoZx5Hw9MLaCFjmWK', 1, 1, 20190323, 1),
(3, 'Budiman', 'budiman@gmail.com', 'default.jpg', '$2y$10$kYvHiIKzCULCqUOVQgcz8.QowPLxheDav5B2VLYc.CPYkFYsqoi.m', 2, 1, 20190323, 0);
...
(12, 10, 'Accounts Receivable', 'accounts_receivable', 'far fa-arrow-alt-circle-right', 1, 'accounts_receivable'),
...
ALTER TABLE `purchase_debts`
  ADD KEY `purchase_debt_id` (`purchase_debt_id`),
  ADD KEY `amount_paid` (`amount_paid`),
  ADD KEY `remaining_paid` (`remaining_paid`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `debt_paid_history` (`debt_paid_history`);
...
ALTER TABLE `sales_account_receivables`
  ADD KEY `sales_ar_id` (`sales_ar_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `ar_paid_history` (`ar_paid_history`);
...
ALTER TABLE `sales_order_details`
  ...
  ADD KEY `so_detail_id` (`so_detail_id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `amount` (`amount`),
  ADD KEY `product_id` (`product_id`);
...
--
ALTER TABLE `sales_order_details`
  MODIFY `so_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
